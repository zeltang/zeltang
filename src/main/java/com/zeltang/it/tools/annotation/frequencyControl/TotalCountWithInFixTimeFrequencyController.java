...
import com.zeltang.it.tools.utils.RedisUtils;
...
@Slf4j
@Service
public class TotalCountWithInFixTimeFrequencyController extends AbstractFrequencyControlService<FrequencyControlVo> {
    /**
     ...
     */
    @Override
    protected boolean reachRateLimit(Map<String, FrequencyControlVo> frequencyControlMap) {
        //批量获取redis统计的值
     ...
     */
    @Override
    protected void addFrequencyControlStatisticsCount(Map<String, FrequencyControlVo> frequencyControlMap) {
