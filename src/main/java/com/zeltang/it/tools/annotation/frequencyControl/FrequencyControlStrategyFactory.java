...
public class FrequencyControlStrategyFactory {
     ...
     */
    public static <K extends FrequencyControlVo> void registerFrequencyController(String strategyName, AbstractFrequencyControlService<K> abstractFrequencyControlService) {
    ...
    public static <K extends FrequencyControlVo> AbstractFrequencyControlService<K> getFrequencyControllerByName(String strategyName) {
